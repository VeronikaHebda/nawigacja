...
ax1 = fig1.add_subplot(xlabel = "czas [h]", ylabel = "liczba satelit")
ax1.set_title("Wykres liczby satelit")
ax1.grid()
...
plt.subplots_adjust(bottom=0.1,
                        ...
                        left=0.1,
                        right=0.74)
ax2 = fig2.add_subplot(xlabel = "czas [min]", ylabel = "elewacja")
ax2.set_title("Wykres elewacji satelit")
ax2.grid()
...
ax4.set_title("Wykres rozmieszczenia satelit")
...
plt.subplots_adjust(bottom=0.1,
                        ...
                        left=0.1,
                        right=0.74)
ax5.set_title("GPS Ground Truck")
ax5.grid()
...
def rysuj():
    ...
    for i in range(0, 24):
        ...
        ilosc_sat, el_sat, dop, nvm, nvm3 = cw2(week, tow, maska, fi, lam)
    ...
    for k in range(0, 144):
        ...
        ilosc_sat, el_sat, nvm1, nvm2, xyz = cw2(week, tow, maska, fi, lam)
    ...
    for j in range(0, 31):
        ...
        if zmienne[j].get() != 0:
            ax2.plot(x2, el_sat0, label='PG' + str(nr))
        nr = nr + 1

    #plt.legend(handles=[gps], bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0., fontsize=15)
    ax2.legend(title='Numer satelit',title_fontsize=9,ncol = 2, loc='center left', bbox_to_anchor=(1, 0.57), fontsize=7)
    ...
    nvm3, nvm4, nvm5, sat_positions, nv6 = cw2(week, tow, maska, fi, lam)
    # define colors
    ...
    fig5.suptitle('GPS Ground Track', fontsize=16)
    ...
    ax5.legend(title='Numer satelit',title_fontsize=15,ncol = 2, loc='center left',
...
Label10 = Label(tab1, text="Maska: ", font=("TimesNewRoman",14),
               fg='black', bd=10, padx=5, pady=5)
Label13 = Label(tab1, text="Wybór satelit: ", font=("TimesNewRoman",14),
               fg='black', bd=10, padx=5, pady=5)
...
satelita27 = Checkbutton(tab1, text = "PG27", variable = qw, onvalue = 1, offvalue = 0,
                        font = ("TimesNewRoman",15))
satelita28 = Checkbutton(tab1, text = "PG28", variable = we, onvalue = 1, offvalue = 0,
                        font = ("TimesNewRoman",15))
satelita29 = Checkbutton(tab1, text = "PG29", variable = er, onvalue = 1, offvalue = 0,
                        font = ("TimesNewRoman",15))
satelita30 = Checkbutton(tab1, text = "PG30", variable = rt, onvalue = 1, offvalue = 0,
                        font = ("TimesNewRoman",15))
satelita31 = Checkbutton(tab1, text = "PG31", variable = ty, onvalue = 1, offvalue = 0,
                        font = ("TimesNewRoman",15))
#satelita1.select()
satelita2.select()
# satelita3.select()
